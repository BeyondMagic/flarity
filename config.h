...
// For italics.
char *font_italic = "VictorMono NF:style=Bold Italic:pixelsize=19:antialias=true:hinting=true";

// For boldness italic.
char *font_bold = "FiraCode NF:style=Regular:pixelsize=19:antialias=true:hinting=true";
